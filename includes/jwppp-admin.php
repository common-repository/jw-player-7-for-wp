...
echo '<div class="wrap">'; 
	...
	echo '<div id="jwppp-description">';
	    //HEADER
		echo "<h1 class=\"jwppp main\">" . __( 'JW Player 7 for Wordrpess', 'jwppp' ) . "</h1>";
	echo '</div>';
 	...
 	<div id="jwppp-settings" class="jwppp-admin">
 		...
 		<?php
			...
			$library = sanitize_text_field(get_option('jwppp-library'));
 			...
 			echo '<tr>';
 			echo '<th scope="row">' . __('Player library URL', 'jwppp') . '</th>';
 			echo '<td>';
 			...
 			echo '<tr>';
 			echo '<th scope="row">' . __('JWP Licence Key', 'jwppp') . '</th>';
 			echo '<td>';
 			...
 			echo ' Don\'t you have one? <a href="http://www.jwplayer.com/pricing/" target="_blank">Take it</a>, it\'s free.</p>';
 			echo '</td>';
 			echo '</tr>';
 			...
 			echo '</select>';
 			echo '<p class="description">' . __('Select the location where you want the video player is displayed.', 'jwppp') . '</p>';
 			echo '</td>';
 			echo '</tr>';
